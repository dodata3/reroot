 ...
 */
OSCMessage::OSCMessage(QString& newAddress)
{
 ...
 */
OSCMessage::OSCMessage(QString& newAddress, QList<QVariant>& newArguments)
{
    construct(newAddress, newArguments);
}

void OSCMessage::construct(QString& newAddress, QList<QVariant>& newArguments)
{
    iAddress = newAddress;
